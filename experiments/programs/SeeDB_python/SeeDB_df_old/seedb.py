...
class SeeDB:
    ...
    def terms(self):
        self.column1, self.where1 = input('Please enter the attribute of the first where clause ->'), input('Please enter specific conditions of the first where clause ->')
        self.column2, self.where2 = input('Please enter the attribute of the second where clause ->'), input('Please enter the specific condition of the second where clause ->')
    ...
    def output(self):
        ...
        print('================================================================')
        print('rank, degree of distance , (aggregate functions, attributes, measures)')
        print('================================================================')
        for i,j in self.top_k.items():
