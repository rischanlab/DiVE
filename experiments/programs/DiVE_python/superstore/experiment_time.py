...
def seedb(df, k, output):
	...
	timeafter = time.time()    
	procesing_time = str(timeafter - timebefore)
	print("SeeDB,{0},{1}".format(k,procesing_time), file=open(output, "a"))
...
def Greedy_Heuristic(df, k, output):
	...
	timeafter = time.time()    
	procesing_time = str(timeafter - timebefore)
	print("Greedy,{0},{1}".format(k,procesing_time), file=open(output, "a"))
...
def SwapU(df, k, output):
	...
	timeafter = time.time()    
	procesing_time = str(timeafter - timebefore)
	print("SwapU,{0},{1}".format(k,procesing_time), file=open(output, "a"))
...
def SwapD(df, k, output):
	...
	timeafter = time.time()    
	procesing_time = str(timeafter - timebefore)
	print("SwapD,{0},{1}".format(k,procesing_time), file=open(output, "a"))
...
output = "output_time_superstore.csv"
n = len(df)
