...
\mas{Given set of all possible views $ \mathbb{V} $, our goal is to recommend set $S \subseteq \mathbb{V}$, where $|S| = k$}. Our hybrid objective function is designed to consider both the importance and diversity of the recommended views. 
%
